...
abstract class $ThemeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ThemeData themeData, ThemeData? darkTheme});
}
...
class _$_ThemeState extends _ThemeState {
  const _$_ThemeState({required this.themeData, this.darkTheme}) : super._();
  ...
  @override
  String toString() {
    return 'ThemeState(themeData: $themeData, darkTheme: $darkTheme)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, themeData, darkTheme);
...
abstract class _ThemeState extends ThemeState {
  const factory _ThemeState(
      ...
      final ThemeData? darkTheme}) = _$_ThemeState;
